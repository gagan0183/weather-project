...
function loadWeather() {
  ...
  var conditionsPath = "http://api.wunderground.com/api/e2b4ef217838bf10/conditions/q/" + zip + ".json";
  var forecastPath = "http://api.wunderground.com/api/e2b4ef217838bf10/forecast/q/" + zip + ".json";
  // GET THE CONDITIONS
